module GPUIntersection4D
    ...
    # Convert Int data to Int64 for the GPU
    function prepare_simplices_for_gpu(P::Matrix{Int}, S_indices::Vector{NTuple{5, Int}})
    ...
    # 4D vector operations for Int64
    ...
    # Core 4D intersection logic using Separating Axis Theorem with Int64
