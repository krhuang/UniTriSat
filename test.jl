...
println("-")
println(styled"{bold, blue:Test 1, Bench 3D. Expect 100% triangulatable polytopes}")
println("-")
results  = triangulate(
    "Polytopes/bench",
...
expected_number = length(results)
...
println("-")
println(styled"{bold, blue:Test 2, Vol 6 3D. Expect 43 triangulatable polytopes}")
println("-")
results  = triangulate(
...
println("-")
println(styled"{bold, blue:Test 3, Vol 12 3D. Expect 745 triangulatable polytopes}")
println("-")
results = triangulate(
...
println("-")
println(styled"{bold, blue:Test 4, Vol 16 3D. Expect 3288 triangulatable polytopes}")
println("-")
results = triangulate(
...
println("-")
println(styled"{bold, blue:Test 5, Vol 10 4D. Expect 618 triangulatable polytopes}")
println("-")
results = triangulate(
...
println("-")
println(styled"{bold, blue:Test 6, Vol 10 5D. Expect 841 triangulatable polytopes}")
println("-")
results = triangulate(
...
println("-")
println(styled"{bold, blue:Test 7, Vol 10 6D. Expect 959 triangulatable polytopes}")
println("-")
results = triangulate(
